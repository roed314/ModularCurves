...
intrinsic DimensionByFormula(M::ModFrmA) -> RngIntElt
...
intrinsic DimensionByFormula(chi::GrpDrchAElt, k::Any : Cuspidal:=false) 
       -> RngIntElt
...
intrinsic DimensionByFormula(N::RngIntElt, chi::GrpDrchAElt, k::Any 
