...
// we look at quotient X_0(74)/w37 because it has rank 2 as X_0(74)
assert rank_quo(74, []) eq rank_quo(74, [37]);
...
P1 := XN(K7)![-1, 0, 0, 1/r7, 2/r7, -2/r7, 1/r7, 1];
P2 := XN(K7)![-1, 0, 0, -1/r7, 2/r7, -2/r7, 1/r7, -1];
...
torsBound := TorsionBound(XN, [2, 37] : PrimesBound := 15);
